...
public class E2ETCPO3 extends BaseTest02 {

	String articleTitle = "Title01"+System.currentTimeMillis();
		
	@Test(dataProvider="getData", groups= {"Publish"})	
	public void loginPublishLogoutTestCase(String userEmail, String userPassword, String userName ) throws IOException
	{
